...
import org.apache.commons.bcel6_RC_4.classfile.ClassParser;
...
public class ClassFileModelLoader {
	...
	protected ConcreteClassifier constructClassifier(JavaClass clazz) {
		...
		for (org.apache.commons.bcel6_RC_4.classfile.Field field : clazz.getFields()) {
		...
		for (org.apache.commons.bcel6_RC_4.classfile.Method method : clazz.getMethods()) {
	...
	protected Member constructMethod(org.apache.commons.bcel6_RC_4.classfile.Method method, ConcreteClassifier emfClassifier, boolean withVariableLength) {
		...
		for(int i = 0; i < method.getArgumentTypes().length; i++) {
			org.apache.commons.bcel6_RC_4.generic.Type argType = method.getArgumentTypes()[i];
			String paramName;
	...
	protected Parameter constructParameter(org.apache.commons.bcel6_RC_4.generic.Type attrType, String paramName) {
	...
	protected Parameter constructVariableLengthParameter(org.apache.commons.bcel6_RC_4.generic.Type attrType, String paramName) {
	...
	protected Field constructField(org.apache.commons.bcel6_RC_4.classfile.Field field, ConcreteClassifier emfClassifier) {
	...
	protected void constructModifiers(AnnotableAndModifiable emfMember, org.apache.commons.bcel6_RC_4.classfile.AccessFlags member) {
	...
	protected EnumConstant constructEnumConstant(
			org.apache.commons.bcel6_RC_4.classfile.Field field) {
	...
	protected List<String> extractParameterNames(final org.apache.commons.bcel6_RC_4.classfile.Method method) {
		...
		final org.apache.commons.bcel6_RC_4.classfile.LocalVariable[] variables = method
