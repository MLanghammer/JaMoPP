 ...
 * 
 * @version $Id: NEWARRAY.java 1694911 2015-08-09 21:21:10Z chas $
...
public class NEWARRAY extends Instruction implements AllocationInstruction, ExceptionThrower,
    ...
    public NEWARRAY(byte type) {
        super(org.apache.commons.bcel6_RC_4.Constants.NEWARRAY, (short) 2);
        this.type = type;
    }
    ...
    public String toString( boolean verbose ) {
        return super.toString(verbose) + " " + org.apache.commons.bcel6_RC_4.Constants.TYPE_NAMES[type];
    }
    ...
    public Class<?>[] getExceptions() {
        return new Class[] {
            org.apache.commons.bcel6_RC_4.ExceptionConstants.NEGATIVE_ARRAY_SIZE_EXCEPTION
        };
    }
