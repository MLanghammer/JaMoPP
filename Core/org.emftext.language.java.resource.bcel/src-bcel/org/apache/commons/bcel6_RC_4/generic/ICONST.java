 ...
 * <PRE>Stack: ... -&gt; ..., </PRE>
 *
 * @version $Id: ICONST.java 1694911 2015-08-09 21:21:10Z chas $
...
public class ICONST extends Instruction implements ConstantPushInstruction {
    ...
    public ICONST(int i) {
        super(org.apache.commons.bcel6_RC_4.Constants.ICONST_0, (short) 1);
        if ((i >= -1) && (i <= 5)) {
            opcode = (short) (org.apache.commons.bcel6_RC_4.Constants.ICONST_0 + i); // Even works for i == -1
        } else {
