 ...
 *
 * @version $Id: GOTO.java 1694911 2015-08-09 21:21:10Z chas $
...
public class GOTO extends GotoInstruction implements VariableLengthInstruction {
    ...
    public GOTO(InstructionHandle target) {
        super(org.apache.commons.bcel6_RC_4.Constants.GOTO, target);
    }
    ...
    public void dump( DataOutputStream out ) throws IOException {
        ...
        if (opcode == org.apache.commons.bcel6_RC_4.Constants.GOTO) {
            super.dump(out);
        } else { // GOTO_W
            index = getTargetOffset();
    ...
    protected int updatePosition( int offset, int max_offset ) {
        ...
        if (Math.abs(i) >= (32767 - max_offset)) { // to large for short (estimate)
            opcode = org.apache.commons.bcel6_RC_4.Constants.GOTO_W;
