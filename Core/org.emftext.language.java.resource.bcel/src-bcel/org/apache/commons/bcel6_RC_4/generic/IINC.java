 ...
 *
 * @version $Id: IINC.java 1694911 2015-08-09 21:21:10Z chas $
...
public class IINC extends LocalVariableInstruction {
    ...
    public IINC(int n, int c) {
        ...
        this.opcode = org.apache.commons.bcel6_RC_4.Constants.IINC;
        this.length = (short) 3;
    ...
    public void dump( DataOutputStream out ) throws IOException {
        if (wide) {
            out.writeByte(org.apache.commons.bcel6_RC_4.Constants.WIDE);
        }
    ...
    private void setWide() {
        wide = (n > org.apache.commons.bcel6_RC_4.Constants.MAX_BYTE) || (Math.abs(c) > Byte.MAX_VALUE);
        if (wide) {
